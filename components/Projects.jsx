...
//                 radius="lg"
//                 ref={modalRef}
//                 className="border-none bg-[#0e0e10] bg-transparent backdrop-blur-md text-center relative w-full max-w-xl max-h-[80vh] overflow-auto"
//               >
//                 <CardBody>
              ...
              return selectedId === null || item.id !== selectedId ? (
                ...
                >
                  <AnimatePresence>
                    {hoveredIndex === idx && (
                      <motion.span
                        className="absolute inset-0 h-full w-full bg-[#191f20] block rounded-3xl"
